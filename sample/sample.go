...
func callGrpc() string {
	...
	webMercSpatialReference := &pb.SpatialReferenceData{Wkid:3857}
	wgs84Spatialreference := &pb.SpatialReferenceData{Proj4:"+init=epsg:4326"}
	...
	serviceGeometry := pb.GeometryBagData{
		...
		SpatialReference:     webMercSpatialReference,
	}
	...
	operatorSimplify := &pb.OperatorRequest{
		...
		OperationSpatialReference:webMercSpatialReference,
	}

	operatorGeneralize := &pb.OperatorRequest{
		GeometryRequest:operatorSimplify,
		GeneralizeByAreaParams:&pb.GeneralizeByAreaParams{RemoveDegenerates:true, PercentReduction:40},
	...
	operatorProject := &pb.OperatorRequest{
		...
		ResultsEncodingType:pb.GeometryEncodingType_wkt,
		ResultSpatialReference:wgs84Spatialreference,
	}
	...
	log.Println(operatorResult.GeometryBag.Wkt[0])

	return operatorResult.GeometryBag.Wkt[0]
}
